...
<div class="nav-header">
    <a href="{{ url('/') }}" class="brand-logo">
        <div class="logo-abbr">
            <img src="{{ asset('logos/icon.png') }}" width="40">
        </div>
        <img class="logo-compact" src="{{ asset('dash/images/logo-text.png') }}" alt="">
        <div class="brand-title" style="color: black;font-size: 25px;">
            {{ env('APP_NAME') }}
        </div>
    </a>
                ...
                <ul class="navbar-nav header-right">
                    ...
                    <li class="nav-item dropdown notification_dropdown">
                        <a class="nav-link  ai-icon" href="javascript:void(0)" role="button" data-bs-toggle="dropdown">
                            ...
                            <span class="badge text-white badge-primary rounded-circle">4</span>
                        </a>
                                    ...
                                    <li>
                                        <div class="timeline-panel">
                                            <div class="media me-2">
                                                <img alt="image" width="50" src="{{ asset('dash/images/avatar/1.jpg') }}">
                                            </div>
                    ...
                    <li class="nav-item dropdown header-profile">
                        <a class="nav-link" href="javascript:void(0)" role="button" data-bs-toggle="dropdown">
                            <img src="{{ \App\Helpers\get_user_pic() }}" width="20" alt=""/>
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <form method="POST" action="{{ route('logout') }}">
                                @csrf
                                <a href="javascript:void(0);" class="dropdown-item ai-icon" onclick="event.preventDefault();
                                                this.closest('form').submit();" title="Logout">
                                    <svg id="icon-logout" xmlns="http://www.w3.org/2000/svg" class="text-danger" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"></path><polyline points="16 17 21 12 16 7"></polyline><line x1="21" y1="12" x2="9" y2="12"></line></svg>
                                    <span class="ms-2">{{ __('web.logout') }}</span>
                                </a>
                            </form>
                        </div>
                    </li>
