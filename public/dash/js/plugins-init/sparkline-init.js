	...
	var sparkLine8 = function(){
		if(jQuery('#sparkline8').length > 0 ){
			$("#sparkline8").sparkline([79, 72, 29, 6, 52, 32, 73, 40, 14, 75, 77, 39, 9, 15, 10], {
				...
				height: "50",
				lineColor: "#266C35",
				fillColor: "rgba(41, 83, 232, .5)",
				minSpotColor: "#266C35",
				maxSpotColor: "#266C35",
				highlightLineColor: "#266C35",
				highlightSpotColor: "#266C35",
		...
		if(jQuery('#StackedBarChart').length > 0 ){
			$('#StackedBarChart').sparkline([
				...
				[4, 1, 2]
					...
					barWidth: 10,
					barSpacing: 7,
					stackedBarColor: ['#2DB3FF', '#2BC155', '#FF4C41']
				});
		}
	}
	...
	var sparkLine11 = function(){
		if(jQuery('#sparkline11').length > 0 ){
			...
			$("#sparkline11").sparkline([24, 61, 51], {
				...
				height: "100px",
				resize: !0,
				sliceColors: ["rgba(192, 10, 39, .5)", "rgba(0, 0, 128, .5)", "rgba(41, 83, 232, .5)"]
			});
		}
	}
