	...
	var dlabMorris = function(){
		...
		var donutChart = function(){
			Morris.Donut({
				...
				resize: true,
				redraw: true,
				colors: ['#2DB3FF', 'rgb(41, 83, 232)', '#2BC155'],
				//responsive:true,
		...
		var lineChart2 = function(){
			...
			Morris.Area({
				...
				pointSize: 3,
				fillOpacity: 0,
				pointStrokeColors: ['#FF4C41', '#2BC155', '#2DB3FF'],
				behaveLikeLine: true,
				gridLineColor: 'transparent',
				lineWidth: 3,
				hideHover: 'auto',
				lineColors: ['rgb(41, 83, 232)', 'rgb(43, 193, 85)', '#2DB3FF'],
				resize: true
		...
		var barChart = function(){
			...
			Morris.Bar({
				...
				ykeys: ['a', 'b', 'c'],
				labels: ['A', 'B', 'C'],
				barColors: ['#266C35', '#2BC155', '#ff9f00'],
				hideHover: 'auto',
				gridLineColor: 'transparent',
				resize: true,
				barSizeRatio: 0.25,
		...
		var areaChart = function(){
			...
			Morris.Area({
				...
				lineColors: ['#2DB3FF', 'rgb(16, 202, 147)', 'rgb(41, 83, 232)'],
				xkey: 'period',
				ykeys: ['smartphone', 'windows', 'mac'],
				labels: ['Phone', 'Windows', 'Mac'],
				pointSize: 0,
